...
- ありきたりな言い換えで平らにしない。「頭の疲れ」「毎回かかる手間」のような説明語だけで終わらせず、生活の手触りがある言葉を選ぶ。
- 難しい概念は、身近な場面の比喩で伝える。例: 頭の中の台所が散らかる、未来の自分に小さな請求書を送る、時間の蛇口を開けっぱなしにする。
- メモの中にある「その人だけの呼び名」を1つ作る。例: 無料のふりをした疲れ、あとで払う自由、見えない家事ローン。
- 「最大の錯覚」「本当の論点」は探すが、説明はやさしく、言葉は少しだけ詩的にする。
- 1文を長くしすぎない。3〜5段落で、読みやすさと余韻を両立する。
